    ...
    render:function(){
        ...
        for(var i=0;i<content.blocks.length;i++){
            ...
            for(var i=0;i<block.links.length;i++){
                links.push(React.createElement("a", {className: "card-link", href: block.links[i].url}, block.links[i].name));
            }
            blocks.push(
                ...
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-sm-4"}, 
                        React.createElement("div", {className: "card"}, 
                            ...
                            React.createElement("img", {className: "card-img-top", src: content.imgTop.url, alt: content.imgTop.alt}), 
                            blocks, 
                            React.createElement("ul", {className: "list-group list-group-flush"}, 
                                listgroup
                            ), 
                            React.createElement("img", {className: "card-img-bottom", src: content.imgBottom.url, alt: content.imgBottom.alt}), 
...
React.render(React.createElement(Card, {content: content}),document.body);
},{"./Card.jsx":2,"react/addons":4}],4:[function(require,module,exports){
